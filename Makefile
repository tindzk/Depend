...
LIBFILES += $(LIBPATH)/{Directory,Runtime,Kernel,Block,Process,Path,Char,String{,Stream},Backtrace,Integer,Memory,ExceptionManager,Tree,Terminal{,/Controller},Typography,File,BufferedStream,FileStream,Hex,Logger}.c
